        ...
        <div className="flex h-screen flex-col justify-between border-e border-t bg-white">
          <div className="px-4 py-6">
            ...
            <ul className="mt-6 space-y-1">
              ...
              <li>
                <a href="/history" className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
              ...
              <li>
                <details className="group [&_summary::-webkit-details-marker]:hidden">
                  ...
                  <ul className="mt-2 space-y-1 px-4">
                    ...
                    <li>
                      <button onClick={handleLogout} className="w-full rounded-lg px-4 py-2 text-sm font-medium text-red-300 [text-align:_inherit] hover:bg-gray-100 hover:text-red-600">
                        Log Out
                      </button>
                    </li>
                  </ul>
